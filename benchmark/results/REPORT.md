...
| model | clean | 20dB | 15dB | 10dB | 5dB | 0dB | mean |
|---|---|---|---|---|---|---|---|
| silero | 0.0075 | 0.0066 | 0.0065 | 0.0068 | 0.0069 | 0.0070 | **0.0069** |
| marblenet | 0.0029 | 0.0029 | 0.0028 | 0.0028 | 0.0027 | 0.0028 | **0.0028** |
| marblenet-int8 | 0.0087 | 0.0084 | 0.0080 | 0.0083 | 0.0087 | 0.0087 | **0.0085** |
| fsmn | 0.0078 | 0.0077 | 0.0075 | 0.0076 | 0.0074 | 0.0076 | **0.0076** |
| fsmn-quant | 0.0071 | 0.0064 | 0.0067 | 0.0065 | 0.0067 | 0.0067 | **0.0067** |
| speechbrain | 0.0133 | 0.0125 | 0.0126 | 0.0125 | 0.0130 | 0.0130 | **0.0128** |
| pyannote | 0.0069 | 0.0068 | 0.0070 | 0.0068 | 0.0068 | 0.0073 | **0.0069** |
| webrtc | 0.0007 | 0.0008 | 0.0007 | 0.0008 | 0.0008 | 0.0007 | **0.0008** |
...
- **silero**: clean AUC 0.986 → 0 dB 0.932 (Δ0.054); mean RTF 0.0069.
- **marblenet**: clean AUC 0.984 → 0 dB 0.939 (Δ0.045); mean RTF 0.0028.
- **marblenet-int8**: clean AUC 0.984 → 0 dB 0.940 (Δ0.044); mean RTF 0.0085.
- **fsmn**: clean AUC 0.973 → 0 dB 0.918 (Δ0.055); mean RTF 0.0076.
- **fsmn-quant**: clean AUC 0.973 → 0 dB 0.918 (Δ0.055); mean RTF 0.0067.
- **speechbrain**: clean AUC 0.877 → 0 dB 0.665 (Δ0.212); mean RTF 0.0128.
- **pyannote**: clean AUC 0.986 → 0 dB 0.969 (Δ0.017); mean RTF 0.0069.
- **webrtc**: clean AUC 0.895 → 0 dB 0.658 (Δ0.237); mean RTF 0.0008.
